...
storiesOf("Text", module)
  ...
  .add("Primary", () => (
    <Text.Primary>{text("Some text", DEFAULT_TEXT)}</Text.Primary>
  ))
  .add("Secondary", () => (
    <Text.Secondary>{text("Some text", DEFAULT_TEXT)}</Text.Secondary>
  ))
  .add("Tertiary", () => (
    <Text.Tertiary>{text("Some text", DEFAULT_TEXT)}</Text.Tertiary>
  ));
